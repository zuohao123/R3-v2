...
def export_split(ds: Dataset, split: str, out_dir: str, log_every: int) -> None:
...
def main() -> None:
    ...
    export_split(_get_split(train_ds, "train"), "train", args.out_dir, args.log_every)
    export_split(_get_split(test_ds, "test"), "test", args.out_dir, args.log_every)
