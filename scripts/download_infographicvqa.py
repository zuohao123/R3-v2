...
def export_split(ds: Dataset, split: str, out_dir: str) -> None:
...
def main() -> None:
    ...
    export_split(_get_split(train_ds, "train"), "train", args.out_dir)
    export_split(_get_split(test_ds, "test"), "test", args.out_dir)
